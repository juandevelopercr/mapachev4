...
/**
 * Class m210829_013657_create_table_credit_note
 */
class m210829_013657_create_table_credit_note extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable(
            ...
            [
                ...
                'correct_credit_note' => $this->tinyInteger()->defaultValue('0')->comment('1 Si corrige una factura'),
                'correct_credit_note_id' => $this->integer()->comment( 'id de la factura que corrige'),
        ...
        $this->addForeignKey(
            'fk_credit_note_condition_sale1',
            '{{%credit_note}}',
            ['condition_sale_id'],
            '{{%condition_sale}}',
            ['id'],
        ...
        $this->addForeignKey(
            'fk_credit_note_credit_note1',
            '{{%credit_note}}',
            ['correct_credit_note_id'],
            '{{%credit_note}}',
            ['id'],
            'CASCADE',
            'CASCADE'
        ...
        $this->addForeignKey(
            'fk_credit_note_route_transport1',
            '{{%credit_note}}',
            ['route_transport_id'],
            '{{%route_transport}}',
            ['id'],
