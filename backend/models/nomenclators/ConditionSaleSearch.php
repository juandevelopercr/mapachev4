...
/**
 * ConditionSaleSearch represents the model behind the search form of `backend\models\nomenclators\ConditionSale`.
 */
class ConditionSaleSearch extends ConditionSale
{
    /**
     * @inheritdoc
     */
