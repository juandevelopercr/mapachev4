...
class IdentificationType extends BaseModel
{
    ...
    {
        return $this->hasMany(Customer::className(), ['identification_type_id' => 'id']);
    }
    ...
    */
    ...
    public static function getSelectMapCustomerAdd()
    {
        $query = self::find();
        $query->where(['status' => self::STATUS_ACTIVE, 'id'=>[6,7]]);
