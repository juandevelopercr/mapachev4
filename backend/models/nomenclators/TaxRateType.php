...
/**
 * This is the model class for table "tax_rate_type".
 *
 * @property int $id
 ...
 */
class TaxRateType extends BaseModel
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'percent' => Yii::t('backend', 'Porciento'),
    ...
    {
        return $this->hasMany(Product::className(), ['tax_rate_type_id' => 'id']);
    }
