 ...
 * @property string $back_image_login
 * @property string|null $product_price_change_mails
 * @property string|null $proforma_stock_alert_mails
 *
...
class Setting extends BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['line_number_ticket', 'line_number_invoice'], 'integer'],
            [['phone', 'address', 'email', 'seo_keywords', 'mini_header_logo', 'name', 'main_logo', 'header_logo','back_image_login'], 'string', 'max' => 255],
            [['description', 'bank_information', 'sinpe_movil'], 'string'],
            [['product_price_change_mails', 'proforma_stock_alert_mails','cashier_report_header'], 'string'],
            [['email'], 'email'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'back_image_login' => Yii::t('backend', 'Imagen de fondo de login'),
            'file_back_image_login' => Yii::t('backend', 'Imagen de fondo de login'),
            'product_price_change_mails' => Yii::t('backend', 'Correos alerta cambio de precios'),
            'proforma_stock_alert_mails' => Yii::t('backend', 'Correos alerta stock insuficiente'),
            'bank_information' => Yii::t('backend', 'Información de cuentas de Banco'),
            'cashier_report_header' => Yii::t('backend', 'Encabezado reporte de caja'),
            'sinpe_movil'=> Yii::t('backend', 'Sinpe Movil'),
            'line_number_ticket'=>Yii::t('backend', 'Número de líneas en tiquetes'),
            'line_number_invoice'=>Yii::t('backend', 'Número de líneas en facturas'),
        ];
    }
    ...
    public function getImageFile($type)
    {
        switch ($type)
        {
            ...
            case 4:
                {
                    if(isset($this->back_image_login) && !empty($this->back_image_login) && $this->back_image_login !== '')
                        return 'images/'.$this->back_image_login;
                    else
                        return null;
                    break;
                }
     ...
     * @param $type // [1 => main_logo, 2 => header_logo, 3 => mini_logo_header, 4 => back_image_login]
     * @return string
     */
    public function getImageUrl($type)
    {
        ...
        switch ($type)
        {
            ...
            case 4:
                {
                    $logo = isset($this->back_image_login) ? $this->back_image_login : 'background_image_login.jpg';
                    break;
                }
        }
     ...
     * @param $type // [1 => main_logo, 2 => header_logo, 3 => mini_header_logo, 4 => back_image_login]
    ...
    public function uploadImage($file_name_atrributte,$type) {
        ...
        switch ($type)
        {
            ...
            case 4:
                {
                    $this->back_image_login = "back_image_login_$language_active.{$ext}";
                    break;
                }
        }
     ...
     * @param integer $type // [1 => main_logo, 2 => header_logo, 3 => mini_header_logo,4 => back_image_login]
    ...
    public static function getUrlLogoBySettingAndType($type,$setting_id=null)
    {
        ...
        if($setting_id !== null)
        {
            ...
            if($model)
            {
                switch ($type)
                {
                    ...
                    case 4:
                        {
                            if($model->back_image_login === null || $model->back_image_login === '')
                            {
                                $url = $path.'background_image_login.jpg';
                            }
                            else
                            {
                                $url = $path.''.$model->back_image_login;
                            }
                            break;
                        }
                }
        ...
        switch ($type)
        {
            ...
            case 4:
                {
                    $path_return = $path.'background_image_login.jpg';
                    break;
                }
        }
     ...
     * @return string
     */
    public static function getLineNumTicket()
    {
        $model = Setting::findOne(self::SETTING_ID);
        ...
        {
            return $model->line_number_ticket;
        }
    }    
     ...
     * @return string
     */
    public static function getLineNumInvoice()
    {
        $model = Setting::findOne(self::SETTING_ID);
        ...
        {
            return $model->line_number_invoice;
        }
    }        
}
