...
/**
 * This is the model class for table "seller_has_debit_note".
 *
 ...
 */
class SellerHasDebitNote extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['debit_note_id', 'seller_id'], 'required'],
            [['debit_note_id', 'seller_id'], 'default', 'value' => null],
            [['debit_note_id', 'seller_id'], 'integer'],
            [['debit_note_id', 'seller_id'], 'unique', 'targetAttribute' => ['debit_note_id', 'seller_id']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'seller_id' => Yii::t('backend', 'Agente Vendedor'),
        ];
    }
    ...
    */
     ...
     * @return bool
     */
    public static function addRelation($seller_id, $debit_note_id)
    {
        $model= new SellerHasDebitNote();
     ...
     */
    public static function deleteRelation($seller_id, $debit_note_id)
    {
        $model= self::find()->where(['debit_note_id' => $debit_note_id, 'seller_id' => $seller_id])->one();
     ...
     * @param $debit_note_id
     * @param bool $as_array
     * @return array|SellerHasDebitNote[]|\yii\db\ActiveRecord[]
     */
    public static function getSellerByDebitNoteId($debit_note_id,$as_array = true)
    {
        $query= self::find()
     ...
     * @return string
     */
    public static function getSellerStringByDebitNote($id)
    {
        ...
        {
            $relations = self::getSellerByDebitNoteId($id,false);
            $array = [];
            foreach ($relations AS $key => $value)
            {
                $array[] = $value->seller->name. ' '. $value->seller->last_name;
            }
    ...
    {
        $items_assigned = self::getSellerByDebitNoteId($id);
