...
/**
 * ItemDebitNoteSearch represents the model behind the search form of `backend\models\business\ItemDebitNote`.
 */
class ItemDebitNoteSearch extends ItemDebitNote
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'debit_note_id', 'product_id', 'service_id', 'user_id', 'price_type','unit_type_id', 'tax_type_id', 'tax_rate_type_id'], 'integer'],
