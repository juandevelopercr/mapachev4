...
/**
 * This is the model class for table "item_invoice".
 *
 * @property int $id
 ...
 */
class ItemInvoice extends BaseModel
{
    ...
    {
        return [
            [['invoice_id','code','description','quantity','subtotal','price_unit'],'required'],
            ...
            [['invoice_id', 'product_id', 'service_id', 'user_id', 'price_type','unit_type_id', 'tax_type_id', 'tax_rate_type_id', 'exoneration_document_type_id', 'exoneration_purchase_percent'], 'integer'],
    ...
    */
    ...
    public function fields()
    {
        ...
        $fields['product_label'] = function(ItemInvoice $model){
            return isset($model->product_id)? $model->product->description : '';
        };

        $fields['service_id'] = 'service_id';
        $fields['service_label'] = function(ItemInvoice $model){
        ...
        $fields['price_type_label'] = function(ItemInvoice $model){
        ...
        $fields['unit_type_label'] = function(ItemInvoice $model){
            return isset($model->unit_type_id)? $model->unitType->code : '';
        };

        $fields['user_id'] = 'user_id';
        $fields['user_label'] = function(ItemInvoice $model){
