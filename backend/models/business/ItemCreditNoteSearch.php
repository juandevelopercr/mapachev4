...
/**
 * ItemCreditNoteSearch represents the model behind the search form of `backend\models\business\ItemCreditNote`.
 */
class ItemCreditNoteSearch extends ItemCreditNote
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'credit_note_id', 'product_id', 'service_id', 'user_id', 'price_type','unit_type_id', 'tax_type_id', 'tax_rate_type_id'], 'integer'],
