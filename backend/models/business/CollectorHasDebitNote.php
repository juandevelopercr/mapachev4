...
/**
 * This is the model class for table "collector_has_debit_note".
 *
 ...
 */
class CollectorHasDebitNote extends \yii\db\ActiveRecord
{
    ...
    {
        return 'collector_has_debit_note';
    }
    ...
    {
        return [
            [['debit_note_id', 'collector_id'], 'required'],
            [['debit_note_id', 'collector_id'], 'default', 'value' => null],
            [['debit_note_id', 'collector_id'], 'integer'],
            [['debit_note_id', 'collector_id'], 'unique', 'targetAttribute' => ['debit_note_id', 'collector_id']],
    ...
    {
        return [
            'debit_note_id' => Yii::t('backend', 'Factura'),
    ...
    */
    ...
    {
        return "/collector-has-debit_note";
    }
    ...
    */
     ...
     * @return bool
     */
    public static function addRelation($collector_id, $debit_note_id)
    {
        $model= new CollectorHasDebitNote();
     ...
     */
    public static function deleteRelation($collector_id, $debit_note_id)
    {
        $model= self::find()->where(['debit_note_id' => $debit_note_id, 'collector_id' => $collector_id])->one();
     ...
     * @param $debit_note_id
     * @param bool $as_array
     * @return array|CollectorHasDebitNote[]|\yii\db\ActiveRecord[]
     */
    public static function getCollectorByDebitNoteId($debit_note_id,$as_array = true)
    {
        $query= self::find()
     ...
     * @return string
     */
    public static function getCollectorStringByDebitNote($id)
    {
        ...
        {
            $relations = self::getCollectorByDebitNoteId($id,false);
            $array = [];
    ...
    {
        $items_assigned = self::getCollectorByDebitNoteId($id);
