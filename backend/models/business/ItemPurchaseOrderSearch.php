...
/**
 * ItemPurchaseOrderSearch represents the model behind the search form of `backend\models\business\ItemPurchaseOrder`.
 */
class ItemPurchaseOrderSearch extends ItemPurchaseOrder
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'purchase_order_id', 'product_id', 'service_id', 'user_id', 'price_type','unit_type_id', 'tax_type_id', 'tax_rate_type_id', 'exoneration_purchase_percent'], 'integer'],
