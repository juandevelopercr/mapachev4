...
/**
 * This is the model class for table "collector_has_purchase_order".
 *
 ...
 */
class CollectorHasPurchaseOrder extends \yii\db\ActiveRecord
{
    ...
    {
        return 'collector_has_purchase_order';
    }
    ...
    {
        return [
            [['purchase_order_id', 'collector_id'], 'required'],
            [['purchase_order_id', 'collector_id'], 'default', 'value' => null],
            [['purchase_order_id', 'collector_id'], 'integer'],
            [['purchase_order_id', 'collector_id'], 'unique', 'targetAttribute' => ['purchase_order_id', 'collector_id']],
    ...
    {
        return [
            'purchase_order_id' => Yii::t('backend', 'Factura'),
    ...
    */
    ...
    {
        return "/collector-has-purchase_order";
    }
    ...
    */
     ...
     * @return bool
     */
    public static function addRelation($collector_id, $purchase_order_id)
    {
        $model= new CollectorHasPurchaseOrder();
     ...
     */
    public static function deleteRelation($collector_id, $purchase_order_id)
    {
        $model= self::find()->where(['purchase_order_id' => $purchase_order_id, 'collector_id' => $collector_id])->one();
     ...
     * @param $purchase_order_id
     * @param bool $as_array
     * @return array|CollectorHasPurchaseOrder[]|\yii\db\ActiveRecord[]
     */
    public static function getCollectorByPurchaseOrderId($purchase_order_id,$as_array = true)
    {
        $query= self::find()
     ...
     * @return string
     */
    public static function getCollectorStringByPurchaseOrder($id)
    {
        ...
        {
            $relations = self::getCollectorByPurchaseOrderId($id,false);
            $array = [];
    ...
    {
        $items_assigned = self::getCollectorByPurchaseOrderId($id);
