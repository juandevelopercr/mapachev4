...
/**
 * This is the model class for table "payment_method_has_credit_note".
 *
 ...
 */
class PaymentMethodHasCreditNote extends \yii\db\ActiveRecord
{
    ...
    {
        return 'payment_method_has_credit_note';
    }
    ...
    {
        return [
            [['credit_note_id', 'payment_method_id'], 'required'],
            [['credit_note_id', 'payment_method_id'], 'default', 'value' => null],
            [['credit_note_id', 'payment_method_id'], 'integer'],
            [['credit_note_id', 'payment_method_id'], 'unique', 'targetAttribute' => ['credit_note_id', 'payment_method_id']],
    ...
    */
    ...
    {
        return "/payment-method-has-credit-note";
    }
    ...
    */
     ...
     * @return bool
     */
    public static function addRelation($payment_method_id, $credit_note_id)
    {
        $model= new PaymentMethodHasCreditNote();
     ...
     */
    public static function deleteRelation($payment_method_id, $credit_note_id)
    {
        $model= self::find()->where(['credit_note_id' => $credit_note_id, 'payment_method_id' => $payment_method_id])->one();
     ...
     * @param $credit_note_id
     * @param bool $as_array
     * @return array|PaymentMethodHasCreditNote[]|\yii\db\ActiveRecord[]
     */
    public static function getPaymentMethodByCreditNoteId($credit_note_id,$as_array = true)
    {
        $query= self::find()
     ...
     * @return string
     */
    public static function getPaymentMethodStringByCreditNote($id)
    {
        ...
        {
            $relations = self::getPaymentMethodByCreditNoteId($id,false);
            $array = [];
    ...
    {
        $items_assigned = self::getPaymentMethodByCreditNoteId($id);
