...
/**
 * This is the model class for table "seller_has_invoice".
 *
 ...
 */
class SellerHasInvoice extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['invoice_id', 'seller_id'], 'required'],
            [['invoice_id', 'seller_id'], 'default', 'value' => null],
            [['invoice_id', 'seller_id'], 'integer'],
            [['invoice_id', 'seller_id'], 'unique', 'targetAttribute' => ['invoice_id', 'seller_id']],
    ...
    */
     ...
     * @return bool
     */
    public static function addRelation($seller_id, $invoice_id)
    {
        $model= new SellerHasInvoice();
     ...
     */
    public static function deleteRelation($seller_id, $invoice_id)
    {
        $model= self::find()->where(['invoice_id' => $invoice_id, 'seller_id' => $seller_id])->one();
     ...
     * @param $invoice_id
     * @param bool $as_array
     * @return array|SellerHasInvoice[]|\yii\db\ActiveRecord[]
     */
    public static function getSellerByInvoiceId($invoice_id,$as_array = true)
    {
        $query= self::find()
     ...
     * @return string
     */
    public static function getSellerStringByInvoice($id)
    {
        ...
        {
            $relations = self::getSellerByInvoiceId($id,false);
            $array = [];
    ...
    {
        $items_assigned = self::getSellerByInvoiceId($id);
