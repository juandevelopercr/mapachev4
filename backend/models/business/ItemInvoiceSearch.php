...
/**
 * ItemInvoiceSearch represents the model behind the search form of `backend\models\business\ItemInvoice`.
 */
class ItemInvoiceSearch extends ItemInvoice
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'invoice_id', 'product_id', 'service_id', 'user_id', 'price_type','unit_type_id', 'tax_type_id', 'tax_rate_type_id', 'exoneration_purchase_percent'], 'integer'],
            [['code', 'description', 'created_at', 'updated_at', 'number_exoneration_doc', 'name_institution_exoneration', 'exoneration_date'], 'safe'],
