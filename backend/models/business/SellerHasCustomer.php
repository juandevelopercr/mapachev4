...
/**
 * This is the model class for table "seller_has_customer".
 *
 ...
 */
class SellerHasCustomer extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['customer_id', 'seller_id'], 'default', 'value' => null],
            [['customer_id', 'seller_id'], 'integer'],
            [['customer_id', 'seller_id'], 'unique', 'targetAttribute' => ['customer_id', 'seller_id']],
    ...
    */
     ...
     * @return bool
     */
    public static function addRelation($seller_id, $customer_id)
    {
        $model= new SellerHasCustomer();
     ...
     */
    public static function deleteRelation($seller_id, $customer_id)
    {
        $model= self::find()->where(['customer_id' => $customer_id, 'seller_id' => $seller_id])->one();
     ...
     * @param $customer_id
     * @param bool $as_array
     * @return array|SellerHasCustomer[]|\yii\db\ActiveRecord[]
     */
    public static function getSellerByCustomerId($customer_id,$as_array = true)
    {
        $query= self::find()
     ...
     * @return string
     */
    public static function getSellerStringByCustomer($id)
    {
        ...
        {
            $relations = self::getSellerByCustomerId($id,false);
            $array = [];
    ...
    {
        $items_assigned = self::getSellerByCustomerId($id);
