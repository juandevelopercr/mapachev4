...
<?= "<?php \n" ?> $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
        ...
        $exception = ['userUpdate','createDate','updateDate','userCreate','created_at','updated_at'];
        foreach ($generator->getColumnNames() as $attribute) {
    ...
    ?>
    ';
                }elseif (($type =='datetime' || $type =='timestamp') && ($attribute !== 'created_at' && $attribute !== 'updated_at')){
                    $fields[] = '
    <?=
