    ...
    public function __construct($header_buttons, $dataProvider, $template = null, $custom_buttons = null)
    {
        ...
        $action_column = [
            ...
            'urlCreator' => function( $action, $model, $key, $index ){
                ...
                if ($action == "view") {
                    return Url::to(['view', 'id' => $key], GlobalFunctions::URLTYPE);
                }
                if ($action === 'update') {                    
                    return Url::to(['update', 'id' => $key], GlobalFunctions::URLTYPE);
                }
                if ($action === 'delete') {
                    return Url::to(['delete', 'id' => $key], GlobalFunctions::URLTYPE);
                }
            },
            'viewOptions' => [
        ...
        $toolbar = [
            ...
            '<div style="margin-top:10px; float:left">{export}</div>',
            '{toggleData}',
        ];
