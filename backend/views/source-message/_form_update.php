        ...
        $my_custom_action_column = [
            ...
            'buttons' => [
                'update' => function($url, $model) {
                    ...
                    $url_path = Url::to(['message/update','id'=>$model->id, 'language'=> $model->language, 'return_update'=>true], GlobalFunctions::URLTYPE);
                ...
                'delete' => function($url, $model) {
                    ...
                    $url_path = Url::to(['message/delete','id'=>$model->id, 'language'=> $model->language, 'return_update'=>true], GlobalFunctions::URLTYPE);
