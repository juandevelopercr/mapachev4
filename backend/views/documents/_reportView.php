  ...
  <table class='kv-grid-table table table-bordered table-striped kv-table-wrap'>
    <thead>
      <tr style="background-color: #f4f4f4;">
            <th class='kv-align-center kv-align-middle' colspan="8" data-col-seq='2' style='font-size:18px' align="center">
	...
	foreach ($datos as $d) : ?>  
    	<?php
          ...
          <tr data-key="<?= $index ?>">
            ...
            <td class='kv-align-center kv-align-middle' data-col-seq='2' style='mso-number-format: &quot;\@&quot;;' align="center"><?= $d->currency ?></td>
            <td class='kv-align-right kv-align-middle' data-col-seq='8'  style='mso-number-format: &quot;\#\,\#\#0\.00&quot;;'><?= number_format($d->change_type, 2, ".", ",") ?></td>
            <td class='kv-align-center kv-align-middle' data-col-seq='2' style='mso-number-format: &quot;\@&quot;;' align="center">
				<?php 
				$str = '';
			...
			<td class='kv-align-center kv-align-middle' data-col-seq='2' style='mso-number-format: &quot;\@&quot;;'><?= $d->state->name ?></td>            
          </tr>
	  <?php
    ...
    <tbody class='kv-page-summary-container'>
      <tr class='kv-page-summary warning'>
	        <td colspan="8" class='kv-align-right kv-align-middle'><strong>Total General</strong></td>
			<td class='kv-align-right kv-align-middle' data-col-seq='8' style='mso-number-format: &quot;\#\,\#\#0\.00&quot;;'><strong><?= number_format($sum_subtotal, 2, ".", ",") ?></strong></td>            
			<td class='kv-align-right kv-align-middle' data-col-seq='7' style='mso-number-format: &quot;\#\,\#\#0\.00&quot;;'><strong><?= number_format($sum_total_iva, 2, ".", ",") ?></strong></td>
			<td class='kv-align-right kv-align-middle' data-col-seq='8' style='mso-number-format: &quot;\#\,\#\#0\.00&quot;;'><strong><?= number_format($sum_total, 2, ".", ",") ?></strong></td>
      </tr>
    </tbody>
	<?php
	endif;
