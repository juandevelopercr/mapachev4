...
$custom_elements_gridview = new Custom_Settings_Column_GridView($resetfiltros, $dataProvider, ['view', 'abonar'], $custom_buttons);
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model, $key, $index, $widget) {
                    $mostrar = true;                    
                    if ($model->status == UtilsConstants::INVOICE_STATUS_CANCELLED)
                        $mostrar = false;
                    else
