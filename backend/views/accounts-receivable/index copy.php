...
$custom_elements_gridview = new Custom_Settings_Column_GridView($pdf_button, $dataProvider, ['view', 'abonar'], $custom_buttons);
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    $color = '';
                    if (is_null($model->status_cuenta_cobrar))
                        $model->status_cuenta_cobrar = UtilsConstants::ACCOUNT_RECEIVABLE_PENDING;
                    
                    $status = (int) $model->status_cuenta_cobrar;
