...
<div class="box-body">
    ...
    */
    ...
    <div class="row">
        <div class="col-md-9">
            <?= GlobalFunctions::beginCustomPanel(count($model->abonosInvoices) . ' ' . Yii::t('backend', 'Abonos'), false, 'box box-danger box-solid') ?>
            ...
            <div class="row">
                <div class="pull-right" style="padding-right: 20px;">  
                    <table cellpadding="5" cellspacing="5" width="200px" align="right" border="0">
                        <tr>
                            <td width="100px" align="right">
                                <strong>Monto</strong>
                            </td>
                            <td width="100px" align="right">
                                <strong><?= $model->currency->symbol ?> <?= GlobalFunctions::formatNumber($total, 2) ?></strong>
                            </td>                            
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td align="right">
                                <strong><?= $model->currency->symbol ?> <?= GlobalFunctions::formatNumber($abonado, 2) ?></strong>
                            </td>                            
                        </tr>  
                        <tr>
                            <td align="right">
                            ...
                            <td align="right">
                                <strong><?= $model->currency->symbol ?> <?= GlobalFunctions::formatNumber($pendiente, 2) ?></strong>
                            </td>                            
                        </tr>                                               
                    </table>
                </div>
