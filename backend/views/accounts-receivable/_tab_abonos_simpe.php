...
$js = Footer_Bulk_Delete::getFooterBulkDelete($url, 'grid_invoice_abonos_sinpe');
...
$this->registerJs('
    $(document).ready(function()
    {
        function init_click_handlers(){                
                $("a.btn-estado-cuenta").click(function(e) {
                    e.preventDefault();        
                    var selectedId = $("#grid_invoice_abonos_sinpe").yiiGridView("getSelectedRows");
    ...
    $("#grid_invoice_abonos_sinpe-pjax").on("pjax:success", function() {
