...
$js = Footer_Bulk_Delete::getFooterBulkDelete($url, 'grid_invoice_canceladas');
...
$this->registerJs('
    $(document).ready(function()
    {
        function init_click_handlers(){                
                $("a.btn-estado-cuenta").click(function(e) {
                    e.preventDefault();        
                    var selectedId = $("#grid_invoice_canceladas").yiiGridView("getSelectedRows");
    ...
    $("#grid_invoice_canceladas-pjax").on("pjax:success", function() {
