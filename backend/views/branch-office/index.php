...
$this->title = Yii::t('backend', 'Sucursales');
...
<?php 
	if (Helper::checkRoute($controllerId . 'create')) {
		$create_button = Html::a('<i class="fa fa-plus"></i> '.Yii::t('backend', 'Generar'), ['generate'], ['class' => 'btn btn-default btn-flat margin', 'title' => Yii::t('backend', 'Generar').' '.Yii::t('backend', 'Sucursal')]).''.Html::a('<i class="fa fa-plus"></i> '.Yii::t('backend', 'Crear'), ['create'], ['class' => 'btn btn-default btn-flat margin', 'title' => Yii::t('backend', 'Crear').' '.Yii::t('backend', 'Sucursal')]);
	}
