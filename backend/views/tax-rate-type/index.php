...
$this->title = Yii::t('backend', 'Tarifas de impuestos');
...
<?php 
	if (Helper::checkRoute($controllerId . 'create')) {
		$create_button = Html::a('<i class="fa fa-plus"></i> '.Yii::t('backend', 'Crear'), ['create'], ['class' => 'btn btn-default btn-flat margin', 'title' => Yii::t('backend', 'Crear').' '.Yii::t('backend', 'Tarifa de impuesto')]);
	}
        ...
        'responsiveWrap' => false,
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($data) {
                        return GlobalFunctions::formatNumber($data->percent,2);
                    },
                    'format' => 'html',
                ],
