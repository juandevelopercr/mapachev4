...
$this->params['breadcrumbs'][] = ['label' => Yii::t('backend', 'Órdenes de pedidos'), 'url' => ['index']];
...
?>
    ...
    <div class="box-body">
            ...
            <div class="col-md-6">
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'attribute'=> 'status',
                            'value'=> UtilsConstants::getPurchaseOrderStatusSelectType($model->status),
                            'format'=> 'html',
                        ],
                ...
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            ...
                            'value'=> GlobalFunctions::formatNumber($model->discount_percent,2),
                            'format'=> 'html',
                        ],

                        [
                            'label'=> Yii::t('backend','Medios de pagos'),
                            'value'=> PaymentMethodHasPurchaseOrder::getPaymentMethodStringByPurchaseOrder($model->id),
                            'format'=> 'html',
                        ],

                        [
                            'attribute'=> 'route_transport_id',
                            'value'=> (isset($model->route_transport_id) && !empty($model->route_transport_id))? $model->routeTransport->code.' - '.$model->routeTransport->name : '',
                            'format'=> 'html',
                        ],
        ...
        <div class="row">
            <div class="col-md-9">
                <?= GlobalFunctions::beginCustomPanel(count($model->itemPurchaseOrders). ' '.Yii::t('backend','Items')) ?>
                <?= ListView::widget([
                    ...
                    'itemView' => '_items',
                    'summary' => false,
                    'emptyText' => Yii::t('backend','No hay items asociados a esta orden de pedido'),
            ...
            <div class="col-md-3">
                ...
                <?php
                $resume = PurchaseOrder::getResumePurchaseOrder($model->id);
                ?>
                <div class="row">
