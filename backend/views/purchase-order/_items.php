...
/* @var $model backend\models\business\ItemPurchaseOrder */
?>
...
<div class="row item_group">
    <div class="col-md-8">
        <div class="row">
            ...
            <div class="col-md-12 custom-padding-5">
                <?= '<b>'.$model->getAttributeLabel('price_type').': </b>'.UtilsConstants::getCustomerAsssignPriceSelectType($model->price_type) ?>
            </div>
            <div class="col-md-12 custom-padding-5">
