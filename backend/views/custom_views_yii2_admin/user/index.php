    ...
    GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value'=>function($data){
                    return (isset($data->branch_office_id)? $data->branchOffice->code.' - '.$data->branchOffice->name : '');
                },
                'filterInputOptions'=>['placeholder'=>'------'],
                'hAlign'=>'center',
            ],
            [
                ...
                'contentOptions'=>['class'=>'kv-align-left kv-align-middle'],
                'filterType'=>GridView::FILTER_SELECT2,
                //'filter'=> Boxes::getSelectMap(),
                'filterWidgetOptions'=>[
                    'pluginOptions'=>['allowClear'=>true],
                    'options'=>['multiple'=>false],
                ],
                'value'=>function($data){
                    return (isset($data->box_id)? $data->box->name : '');
                },
                'filterInputOptions'=>['placeholder'=>'------'],
                'hAlign'=>'center',
            ],            
...
<?php
$url = Url::to(['/security/user/multiple_delete'], GlobalFunctions::URLTYPE);
