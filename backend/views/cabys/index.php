...
$this->title = Yii::t('backend', 'Cabys');
...
<?php 
	if (Helper::checkRoute($controllerId . 'create')) {
		$create_button = Html::a('<i class="fa fa-plus"></i> '.Yii::t('backend', 'Crear'), ['create'], ['class' => 'btn btn-default btn-flat margin', 'title' => Yii::t('backend', 'Crear').' '.Yii::t('backend', 'Cabys')]);
	}
        ...
        'responsiveWrap' => false,
            ...
            'columns' => [
                ...
                [
                    ...
                    'format'=> 'html',
                    'value' => function ($data) {
                        return $data->description_service;
                    }
                ],
