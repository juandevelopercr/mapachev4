    ...
    <div class="box-body">
        <?php            
            $form = ActiveForm::begin([
                'id' => 'dynamic-form', 'options' => ['enctype' => 'multipart/form-data'],
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <?= $form->field($model, 'box_id')->widget(DepDrop::classname(), [
                    ...
                    'data' => ($model->branch_office_id !== '') ? Boxes::getSelectMapSpecific($model->branch_office_id, false) : array(),
                    'options' => ['placeholder' => "----"],
        ...
        <div class="row">
            <div class="col-md-12">
                <?= $this->render('dynamic_form_documentos', [
                    'model' => $model,
                    'form' => $form,
        ...
        <div class="box-footer">
            <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-plus"></i> ' . Yii::t('backend', 'Crear') : '<i class="fa fa-pencil"></i> ' . Yii::t('yii', 'Guardar'), ['class' => 'btn btn-default btn-flat']) ?>
