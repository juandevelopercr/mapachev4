...
<table width="100%">
    <tr>
        <td style="text-align: center; font-weight: bold;">
            ...
            <?php 
            /*
            <span style="font-size: 9px;">Usuario: <?= $invoice->user->name . ' '. $invoice->user->last_name ?></span><br />
            */
            ?>
        </td>
    </tr>
...
<table width="100%">
    <tr>
        <td align="left" valign="top" style="font-weight: bold;">            
            ...
            <span>Número Contrato: <?= $invoice->contract ?></span><br />
            <span style="font-size: 12px;"><?= Yii::t('backend', 'Fecha') . ': ' . GlobalFunctions::formatDateToShowInSystem($invoice->emission_date) ?></span><br />
            <span style="font-size: 12px;">Usuario: <?= $invoice->user->name . ' '. $invoice->user->last_name ?></span><br />
            <?php 
            /*
            <span><?= Yii::t('backend', 'Vendedor') . ': ' . SellerHasInvoice::getSellerStringByInvoice($invoice->id) ?></span><br />
            */
            ?>
        </td>
    </tr>
...
<table width="100%">
    ...
    if ($total_iva_13 > 0 || ($total_iva_1 == 0 && $total_iva_2 == 0)) : ?>
        <tr>
            <td align="right"><span style="font-size: 12px; font-weight: bold;">IVA</span></td>
    ...
    if ($total_iva_1 > 0) : ?>
        <tr>
            <td align="right"><span style="font-size: 12px; font-weight: bold;">IVA 1% (*)</span></td>
    ...
    if ($total_iva_2 > 0) : ?>
        <tr>
            <td align="right"><span style="font-size: 12px; font-weight: bold;">IVA 2% (#)</span></td>
    ...
    ?>
    <tr>
        <td align="right"><span style="font-weight: bold;">Exonerado</span></td>
        <td align="right"><span style="font-weight: bold;"><?= $simbolo . ' ' . GlobalFunctions::formatNumber($total_exonerado, 2) ?></span></td>
    </tr>
    <tr>
