    ...
    <div class="box-body">
        ...
        <div class="alert alert-warning alert-dismissible">
            ...
            <h4><i class="icon fa fa-warning"></i> Nota!</h4>
             Está acción creará un duplicado de la factura que desea corregir. Presione el botón crear y realice las modificaciones necesarias. La factura debe enviarse nuevamente a Hacienda para cancelar la factura de referencia
        </div>

        <?php
        $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
        <?= $form->field($model, 'emission_date')->hiddenInput()->label(false) ?>
        <?= $form->field($model, 'reference_emission_date')->hiddenInput()->label(false) ?>
        ...
        <div class="row" style="margin-bottom:20px;">
            <div class="col-md-12">
                <fieldset id="pedido_minimo_fieldset" style="width: 100%; border: 1px solid #C0C0C0; margin-top:15px">
                    <legend style="width: auto; margin: 0; border: 0; padding-right: 1%; padding-left: 1%; font-size: 14px; font-weight: bold">Datos de la Factura que Corrige</legend>
                    ...
                    <div class="col-md-6">
                        ...
                        $form->field($model, "reference_code")->widget(Select2::classname(), [
                            "data" => ['01'=>'Anula Documento de Referencia'],
                            "language" => Yii::$app->language,
                            "pluginOptions" => [
                                "allowClear" => true
                            ],
    ...
    if(id_value != '' && id_value != null)
    {
        $.ajax({
            ...
            success : function(response) 
            {
                ...
                if(seller_id !== 0)
                {
                    $("#invoice-seller_id").val(seller_id).trigger("change");	
                }
                else 
                {
                    $("#invoice-seller_id").val("").trigger("change");	
                }
