...
$custom_buttons = [
    'update' => function ($url, $model) {
        ...
        if ($model->status_hacienda === UtilsConstants::HACIENDA_STATUS_NOT_SENT) {
            return Html::a('<i class="glyphicon glyphicon-pencil"></i>', Url::to(['/credit-note/update', 'id' => $model->id], GlobalFunctions::URLTYPE), $options);
        }
    },
    ...
    //            {
    //                return Html::a('<i class="fa fa-remove text-danger"></i>', ['/credit-note/correction', 'id' => $model->id], $options);
    //            }
    //        },
    ...
    //                'target' => '_blank'
    //            ];
    //            return Html::a('<i class="fa fa-file-text-o"></i>', ['/credit-note/viewpdfcontingencia', 'id' => $model->id], $options);
    //        },
    'pdf' => function ($url, $model) {
        ...
        return Html::a('<i class="fa fa-file-pdf-o"></i>', Url::to(['/credit-note/viewpdf', 'id' => $model->id], GlobalFunctions::URLTYPE), $options);
    },
    /*
    'print' => function ($url, $model) {
        ...
        return Html::a('<i class="fa fa-print"></i>', Url::to(['/credit-note/printpdf', 'id' => $model->id], GlobalFunctions::URLTYPE), $options);
    },
    */
    ...
    //                'target' => '_blank'
    //            ];
    //            return Html::a('<i class="fa fa-ticket"></i>', ['/credit-note/viewticketpdf', 'id' => $model->id], $options);
    //        },
    'xml' => function ($url, $model) {
        ...
        return Html::a('<i class="fa fa-file-code-o"></i>', Url::to(['/credit-note/viewxml', 'id' => $model->id], GlobalFunctions::URLTYPE), $options);
    },
    ...
    'delete' => function ($url, $model) {
        ...
        if ($model->status_hacienda === UtilsConstants::HACIENDA_STATUS_NOT_SENT) {
            return Html::a('<i class="glyphicon glyphicon-trash"></i>', Url::to(['/credit-note/delete', 'id' => $model->id], GlobalFunctions::URLTYPE), $options);
        }
    },
];
$custom_elements_gridview = new Custom_Settings_Column_GridView($create_button, $dataProvider, ['view', 'update', 'corregir', 'pdf_contingencia', 'pdf', 'xml', 'xmlh', 'delete'], $custom_buttons);
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'html',
                'value' => function ($data) {
                    return Html::a($data->consecutive, ['/credit-note/update', 'id' => $data->id]);
                }
            ],
        ...
        function init_click_handlers(){
                ...
                $("a.btn-sendemail-factura").click(function(e) {
                    ...
                    else
                    {
                        ...
                        var url = "' . Url::to(['/credit-note/enviar-factura-email'], GlobalFunctions::URLTYPE) . '?id="+selectedId[0];
                ...
                $("a.btn-imp-tickets").click(function(e) {
                    ...
                    if(selectedId.length == 0) {
                        ...
                        var url = "' . Url::to(['/credit-note/imp-tickets'], GlobalFunctions::URLTYPE) . '?ids="+selectedId;
                        window.location.href= url;
                    }
                });	
        }
