              ...
              'buttons' => [
                  ...
                  'update' => function($url, $model) {
                      $options = [
                          ...
                          'class' => 'btn btn-xs btn-default btn-flat btn-update_item_creditnote',
                          'aria-label' => Yii::t('backend', 'Actualizar'),
                          'data-pjax' => '0',
                          'data-toggle' => 'tooltip',
                      ];
                      if ($model->creditNote->reference_code != '01')
                        	return Html::a('<i class="glyphicon glyphicon-pencil"></i>', Url::to(['/item-credit-note/update_ajax','id'=>$model->id], GlobalFunctions::URLTYPE), $options);
                  },
                  'delete' => function($url, $model) {
                    ...
                    if ($model->creditNote->reference_code != '01')
                        return Html::a('<i class="glyphicon glyphicon-trash"></i>', Url::to(['/item-credit-note/delete_ajax','id'=>$model->id], GlobalFunctions::URLTYPE), $options);
                }
              ],
          ]
