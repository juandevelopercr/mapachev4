...
/* @var $searchModel backend\models\nomenclators\CurrencySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$controllerId = '/'.$this->context->uniqueId.'/';
$this->title = Yii::t('backend', 'Monedas');
...
<?php 
	if (Helper::checkRoute($controllerId . 'create')) {
		$create_button = Html::a('<i class="fa fa-plus"></i> '.Yii::t('backend', 'Crear'), ['create'], ['class' => 'btn btn-default btn-flat margin', 'title' => Yii::t('backend', 'Crear').' '.Yii::t('backend', 'Monedas')]);
	}
        ...
        'responsiveWrap' => false,
            ...
            'columns' => [
				...
				[
                    ...
                    'value' => function ($data) {
                        return GlobalFunctions::formatNumber($data->change_type,5);
                    },
                    'format' => 'html',
				],
