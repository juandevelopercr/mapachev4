...
?>
    ...
    <div class="box-body">
            ...
            <div class="col-md-6">
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'attribute'=> 'status',
                            'value'=> UtilsConstants::getDebitNoteStatusSelectType($model->status),
                            'format'=> 'html',
                        ],
                        ...
                        [
                            ...
                            'value'=> PaymentMethodHasDebitNote::getPaymentMethodStringByDebitNote($model->id),
                            'format'=> 'html',
                        ],
        ...
        <div class="row">
            <div class="col-md-9">
                <?= GlobalFunctions::beginCustomPanel(count($model->itemDebitNotes). ' '.Yii::t('backend','Items')) ?>
                <?= ListView::widget([
                    ...
                    'itemView' => '_items',
                    'summary' => false,
                    'emptyText' => Yii::t('backend','No hay items asociados a esta nota de débito'),
            ...
            <div class="col-md-3">
                ...
                <?php
                $resume = DebitNote::getResumeDebitNote($model->id);
                ?>
                <div class="row">
