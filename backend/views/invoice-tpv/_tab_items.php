...
?>
    ...
    <div class="item-invoice-index" style="margin-top:15px;" id="panel-grid-item_invoice">
      <?php  echo $this->render('_form-item_search', ['model' => new ItemInvoiceTpvForm(['quantity' => 1,'invoice_id' => $model->id]), 'customer_id' => $model->customer_id]); ?>
        ...
        function updateValores()
		{
			...
			if(fID != "")
			{
                $.ajax({
                    type: \'POST\',			
                    dataType: "json",
                    url : "'.Url::to(['/invoice-tpv/get-resume-invoice?id='.$model->id], GlobalFunctions::URLTYPE).'",
                    data : {id: fID},
