	...
	<!-- /.box-header -->
		...
		<?php  		
				...
				'options' => ['enctype' => 'multipart/form-data'], 'id' => 'formemail',
							  'action' => Url::to(["/invoice-tpv/enviar-factura-email?id=". $model->id], GlobalFunctions::URLTYPE)
				]);
				//echo $form->field($model, 'archivo')->hiddenInput()->label(false);
				echo $form->field($model, 'id')->hiddenInput()->label(false);
		?>
				<h3>Enviar Facturas Mediante Correo Electrónico</h3>
                <div class="row">
					<div class="col-md-4">
