...
/* @var $searchModel \backend\models\business\CustomerContactSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$title = Yii::t('backend', 'Contactos');
?>
<?php
if ($model->isNewRecord) {
    $label_update = Yii::t('backend', 'Para adicionar contactos, debe crear antes el cliente');
...
<div id="panel-form-contact">
    ...
    <input type="hidden" id="customer_id" value="<?= $model->id?>" />
...
$(document).ready(function(e) {
	function init_click_handlers_contact(){
		...
		$("a.btn-create-contact").click(function(e) {
			...
			var url = "'.Url::to(['/customer-contact/create_ajax'], GlobalFunctions::URLTYPE).'?id="+$("#customer_id").val(); 	
			$.ajax({
				type: "GET",
				url : url,     
		...
		$("a.btn-update-contact").click(function(e) {
            ...
            if(selectedId.length == 0) {
				...
				var url = "'.Url::to(['/customer-contact/update_ajax'], GlobalFunctions::URLTYPE).'"; 	
				$.ajax({
					type: "GET",
					url : url,     
        ...
        $("a.btn-delete-contact").click(function(e) {
            ...
            if(selectedId.length == 0) {
				...
				var url = "'.Url::to(['/customer-contact/deletemultiple_ajax'], GlobalFunctions::URLTYPE).'";				
				bootbox.confirm({
