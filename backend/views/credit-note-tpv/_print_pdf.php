    ...
    <tr>
        ...
        <td width="48%" align="right" valign="top">
            <table border="0" cellspacing="0" cellpadding="5" width="100%">
                ...
                <tr>
                    <td><span style="font-size: 9px; font-weight: bold;">IVA</span></td>
                    <td align="right"><span style="font-size: 9px; font-weight: bold;"><?= $simbolo.' '.GlobalFunctions::formatNumber($total_tax, 2)?></span></td>
                </tr>
                <tr>
                    <td width="20%"><span style="font-size: 9px; font-weight: bold;">Total</span></td>
                    <td width="20%" align="right"><span style="font-size: 9px; font-weight: bold;"><?= $simbolo.' '.GlobalFunctions::formatNumber($total_price, 2) ?></span></td>
                </tr>
            </table>
