...
?>
    ...
    <div class="box-body">
                ...
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            ...
                            'value'=> (isset($model->collector_id) && !empty($model->collector_id))? User::getFullNameByUserId($model->collector_id) : null,
                            'format'=> 'html',
                        ],
            ...
            <div class="col-md-6">
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'attribute'=> 'status',
                            'value'=> UtilsConstants::getCreditNoteStatusSelectType($model->status),
                            'format'=> 'html',
                        ],
                        ...
                        [
                            ...
                            'value'=> PaymentMethodHasCreditNote::getPaymentMethodStringByCreditNote($model->id),
                            'format'=> 'html',
                        ],
        ...
        <div class="row">
            <div class="col-md-9">
                <?= GlobalFunctions::beginCustomPanel(count($model->itemCreditNotes). ' '.Yii::t('backend','Items')) ?>
                <?= ListView::widget([
                    ...
                    'itemView' => '_items',
                    'summary' => false,
                    'emptyText' => Yii::t('backend','No hay items asociados a esta nota de crédito'),
            ...
            <div class="col-md-3">
                ...
                <?php
                $resume = CreditNote::getResumeCreditNote($model->id);
                ?>
                <div class="row">
