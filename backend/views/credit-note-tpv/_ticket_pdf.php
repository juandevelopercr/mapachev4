...
/* @var $invoice backend\models\business\CreditNote */
/* @var $items_invoice backend\models\business\ItemCreditNote[] */
...
<table width="100%">
    <tr>
        <td align="left" valign="top" style="font-weight: bold;">
            ...
            <span><?= Yii::t('backend','Vendedor').': '.SellerHasCreditNote::getSellerStringByCreditNote($credit_note->id) ?></span><br/>
        </td>
    </tr>
</table>
...
<table  width="100%">
    ...
    $model = CreditNote::getResumeCreditNote($invoice->id);
