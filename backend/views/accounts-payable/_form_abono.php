...
<div class="box box-warning box-solid">
    ...
    <div class="box-body">
        ...
        <?= $form->field($model, 'accounts_payable_abonos_id')->hiddenInput()->label(false); ?>
        <input type="hidden" id="htotal_amount" value="<?= $total ?>">
        <input type="hidden" id="habonado_amount" value="<?= $abonado ?>">

        <div class="row">
            <div class="col-md-4">
                <label>Total a Pagar: <?= GlobalFunctions::formatNumber($accountsPayable->total_invoice,2) ?> </label>
            </div>
            <div class="col-md-4">
