...
$this->title = Yii::t('backend', 'Traslados');
...
<?php 
	if (Helper::checkRoute($controllerId . 'create')) {
		$create_button = Html::a('<i class="fa fa-plus"></i> '.Yii::t('backend', 'Crear'), ['create','type' => UtilsConstants::ADJUSTMENT_TYPE_TRANFER], ['class' => 'btn btn-default btn-flat margin', 'title' => Yii::t('backend', 'Crear').' '.Yii::t('backend', 'Traslado')]);
	}
        ...
        'responsiveWrap' => false,
            ...
            'columns' => [
                ...
                [
                    ...
                    'value'=> function($model){
                        return $model->targetBranchOffice->code. ' - '.$model->targetBranchOffice->name;
                    },
                    'filterInputOptions'=>['placeholder'=> '------'],
                    'hAlign'=>'center',
                ],
				...
				[
                    ...
                    'label' => Yii::t('backend','Cantidad trasladada'),
					'contentOptions'=>['class'=>'kv-align-left kv-align-middle'],
					'vAlign' => 'middle',
					'hAlign' => 'center',
					'pageSummary' => true,
