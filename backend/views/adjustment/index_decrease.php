...
$this->title = Yii::t('backend', 'Mermas');
...
<?php 
	if (Helper::checkRoute($controllerId . 'create')) {
		$create_button = Html::a('<i class="fa fa-plus"></i> '.Yii::t('backend', 'Crear'), ['create','type' => UtilsConstants::ADJUSTMENT_TYPE_DECREASE], ['class' => 'btn btn-default btn-flat margin', 'title' => Yii::t('backend', 'Crear').' '.Yii::t('backend', 'Merma')]);
	}
