...
use backend\models\business\ServiceSearch;
...
class ServiceController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $model->tax_rate_percent = 0;
        $model->exoneration_purchase_percent = 0;
        $model->exonerated_tax_amount = 0;
        ...
        if ($model->load(Yii::$app->request->post()))
        {
            ...
            try
            {
                if(Service::find()->select(['code'])->where(['code' => $model->code])->exists())
                {
                    $model->code = $model->generateCode();
                }
    ...
    public function actionDelete($id)
    {
        ...
        try
        {
            ...
            {            
                ...
                GlobalFunctions::addFlashMessage('warning',Yii::t('backend','No puede eliminar este registro'));
    ...
    /**
    * Bulk Deletes for existing Service models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    * @return mixed
    */
