...
use backend\models\nomenclators\RouteTransportSearch;
...
/**
 * RouteTransportController implements the CRUD actions for RouteTransport model.
 */
class RouteTransportController extends Controller
{
    ...
    /**
     * Lists all RouteTransport models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new RouteTransportSearch();
    ...
    /**
     * Displays a single RouteTransport model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new RouteTransport model.
     * If creation is successful, the browser will be redirected to the 'index' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new RouteTransport();
        ...
        if ($model->load(Yii::$app->request->post()))
        {
            ...
            try
            {
                if(RouteTransport::find()->select(['code'])->where(['code' => $model->code])->exists())
                {
                    $model->code = $model->generateCode();
                }
    ...
    /**
     * Updates an existing RouteTransport model.
    ...
    /**
     * Deletes an existing RouteTransport model.
    ...
    /**
     * Finds the RouteTransport model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RouteTransport the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RouteTransport::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
    * Bulk Deletes for existing RouteTransport models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    * @return mixed
    */
