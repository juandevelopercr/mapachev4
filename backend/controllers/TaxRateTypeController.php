...
/**
 * TaxRateTypeController implements the CRUD actions for TaxRateType model.
 */
class TaxRateTypeController extends Controller
{
    ...
    /**
     * Lists all TaxRateType models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TaxRateTypeSearch();
    ...
    /**
     * Displays a single TaxRateType model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TaxRateType model.
     * If creation is successful, the browser will be redirected to the 'index' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TaxRateType();
    ...
    /**
     * Updates an existing TaxRateType model.
    ...
    /**
     * Deletes an existing TaxRateType model.
    ...
    /**
     * Finds the TaxRateType model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TaxRateType the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TaxRateType::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    /**
    * Bulk Deletes for existing TaxRateType models.
    * If deletion is successful, the browser will be redirected to the 'index' page.
    * @return mixed
    */
    ...
    public function actionGet_percent($id)
    {
        ...
        $percent = (isset($model->percent) && !empty($model->percent))? $model->percent : 0;
