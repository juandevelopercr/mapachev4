...
<section data-role="section" id="section-section1">
    ...
    <div id="uno" style="border-right: 2px solid #aaa;">
        ...
        <div id="mbar_g">
            ...
            <div id="uno_in" style="margin: 0; padding: 0; border: 0px solid #f00;"></div>

        </div>
    </div>
    <div id="dos" style="padding-left: 3px;">
        <div class="btn-group btn-group-justified" id="btns_cata">
            <?php /*<a href="#" class="btn btn-default" onClick="discount();"><span style="font-weight: 800;">% </span>Descuento</a> */ ?>
            <a data-toggle="modal" href="#" onClick="add_customer();" class="btn btn-default"> <span class="glyphicon glyphicon-user"></span> Cliente
        ...
        <div id='order'>
            <table class="table table-bordered table-hover text-right" id='orderTable' style="margin-top: 20px;">
                <tr class='toprow' style="padding-bottom: 20px;">
            ...
            <div class="row" style="margin-top: 15px; padding-left: 16px">
                <div class="col-md-6" id="orderCustomer">
                    <?= !is_null($customer) ? $customer->name : '' ?>
                </div>
                <div class="col-md-6">
                    <div style="width: 100; margin-right: 15px;;">
                        <table style="margin-top:0px" cellspacing="10" cellpadding="10" align="right" width="100%">
                            <tbody>
                                <tr>
                                    <td class="text-right resumen" width="65%">
                                        <strong>SUBTOTAL</strong>
                                    </td>
                                    <td align="right" class="resumen" style="padding-right: 5px; font-weight: bold;" width="35%">
                                        <span id="total_subtotal">0.0</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-right resumen">
                                        <strong>DESCUENTO</strong>
                                    </td>
                                    <td align="right" class="resumen" style="padding-right: 5px; font-weight: bold;">
                                        <span id="total_discount">0.0</span>
                                    </td>
                                </tr>
                                <tr id="iva_13">
                                    <td class="text-right resumen">
                                    ...
                                    <td align="right" class="resumen" style="padding-right: 5px; font-weight: bold;">
                                        <span id="total_tax_13">0.0</span>
                                    </td>
                                </tr>
                                <tr id="iva_1" style="display: none;">
                                    <td class="text-right resumen">
                                        <strong>IVA 1% (*)</strong>
                                    </td>
                                    <td align="right" class="resumen" style="padding-right: 5px; font-weight: bold;">
                                        <span id="total_tax_1">0.0</span>
                                    </td>
                                </tr>
                                <tr id="iva_2" style="display: none;">
                                    <td class="text-right resumen">
                                        <strong>IVA 2% (#)</strong>
                                    </td>
                                    <td align="right" class="resumen" style="padding-right: 5px; font-weight: bold;">
                                        <span id="total_tax_2">0.0</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-right resumen">
                                    ...
                                    <td align="right" class="resumen" style="padding-right: 5px; font-weight: bold;">
                                        <span id="total_exonerate">0.0</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-right resumen">
            ...
            <div class="row" style="margin-top: 15px;">
                <div class="col-xs-12" style="padding: 0 10px 10px 10px;">
                    <button type="button" class="btn btn-danger btn-sm btn-square btn-block" onclick="checkout(); return false;" style="padding: 15px 0;">
                        <!--Pagar:-->
                        <span id="orderTotal2" style="font-size: 50px; font-weight: 100;">
                            &nbsp;</span>
...
<section data-role="section" id="section-section3">
    ...
    <div id='order2'>
        ...
        <div class="row" style="margin-top: 15px; padding-left: 16px">
            <div class="col-md-6" id="orderCustomer2">

            </div>
            <div class="col-md-6">
                <table style="margin-top:0px" cellspacing="10" cellpadding="10" align="right">
                    <tbody>
                        <tr>
                            <td class="text-right">
                                <strong>Subtotal</strong>
                            ...
                            <td align="right" style="padding-right: 10px; font-weight: bold;">
                                <span id="total_subtotal2">0.0</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="right" style="padding-right: 10px; font-weight: bold;" width="50%">
                                <span id="total_discount2">0.0</span>
                            </td>
                        </tr>
                        ...
                        <tr id="iva2_13">
                            ...
                            <td align="right" style="padding-right: 10px; font-weight: bold;">
                                <span id="total_tax2_13">0.0</span>
                            </td>
                        </tr>
                        <tr id="iva2_1" style="display: none;">
                            <td class="text-right resumen">
                                <strong>IVA 1% (*)</strong>
                            </td>
                            <td align="right" class="resumen" style="padding-right: 5px; font-weight: bold;">
                                <span id="total_tax2_1">0.0</span>
                            </td>
                        </tr>
                        <tr id="iva2_2" style="display: none;">
                            <td class="text-right resumen">
                                <strong>IVA 2% (#)</strong>
                            </td>
                            <td align="right" class="resumen" style="padding-right: 5px; font-weight: bold;">
                                <span id="total_tax2_2">0.0</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="right" style="padding-right: 10px; font-weight: bold;">
                                <span id="total_exonerate2">0.0</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-right">
        ...
        <div class="row">
            <?php //<div class="col-xs-12" style="margin-top: 15px; margin-bottom: 6px; padding-left: 22px" id="orderCustomer2-"></div> 
            ?>
...
$this->registerJs('
        ...
        $(".ssm-overlay").click(function(){
            setTimeout(function(){ mfocus_search();}, 100);
        });   
');
?>