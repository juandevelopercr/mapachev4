    ...
    <div class="box-body">
        ...
        <div class="alert alert-warning alert-dismissible">
            ...
            <h4><i class="icon fa fa-warning"></i> Nota!</h4>
             Está acción creará un duplicado de la factura que desea corregir. Presione el botón crear y realice las modificaciones necesarias en la factura, esta de enviarse nuevamente a Hacienda para cancelar la factura de referencia
        </div>
