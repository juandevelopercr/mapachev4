...
class ExportController extends Controller
{
     ...
     * @return mixed
     */
    public function download($content, $param = NULL)
    {
        /**
         * @var Module $module
         */
    ...
    //      $content = $request->post('export_content', Yii::t('kvgrid', 'No data found'));
        ...
        else
        {
            ...
            $type = $param['export_filetype'];
            $name = $param['export_filename'];
    //      $content = $request->post('export_content', Yii::t('kvgrid', 'No data found'));
    
            $mime = $param['export_mime'];
            $encoding = $param['export_encoding'];
            $bom = $param['export_bom'];
            $config = $param['export_config'];
        }
