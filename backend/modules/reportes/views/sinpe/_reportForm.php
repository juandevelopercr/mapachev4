...
$this->title = 'Reporte de Sinpe Movil';
    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="export_filename" value="entrega-digital" id="inpFileName" />
                <input type="hidden" name="export_mime" value="application/vnd.ms-excel" />
                <input type="hidden" name="export_config" value='{"worksheet":"Sinpe movil","cssFile":""}' />
