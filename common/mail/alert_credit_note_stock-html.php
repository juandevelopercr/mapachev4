...
/* @var $credit_note \backend\models\business\Invoice */
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:520px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666"><?= Yii::t('backend','Notificamos que se realizó una solicitud de compra para el producto') ?> <b><?= $product->code.' - '.$product->description ?></b>, emitida con fecha <br><b><?= GlobalFunctions::formatDateToShowInSystem($credit_note->emission_date) ?></b> desde la Nota de Crédito <b><?= $credit_note->consecutive ?></b> y que supera la existencia actual.<br></p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
